...
Image.register(:player, resource_path('images/noschar.png'))
Image.register(:apple, resource_path('images/apple.png'))
Image.register(:bomb, resource_path('images/bomb.png'))

Sound.register(:get, resource_path('sounds/get.wav'))
Sound.register(:explosion, resource_path('sounds/explosion.wav'))
...
module AppleCatcher
  ...
  class Main
    def initialize
      ...
      @slice = Image[:player].slice(0,0,32,32)
    end
